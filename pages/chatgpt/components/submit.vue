        ...
        <view class="submit">
            <view class="submit-chat">
                <view class="bt-img" @tap="records">
                    <image src="/static/images/send-voice.svg"></image>
                </view>
                <!-- 文本框 -->
                ...
                <view class="bt-img" @tap="emoji">
                    <image src="/static/images/smile.svg"></image>
                </view>
                <view class="bt-img" @tap="more">
                    <image src="/static/images/add-circle.svg"></image>
                </view>
            </view>
            <!-- 表情 -->
            <view class="emoji" :class="{displaynone:!isemoji}">
                <view class="emoji-send">
                    <view class="emoji-send-det" @tap="emojiBack">
                        <image src="/static/images/delete.svg"></image>
                    </view>
            ...
            <view class="more" :class="{displaynone:!ismore}">
                <view class="more-list" @tap="sendImg('album')">
                    <image src="/static/images/picture.svg"></image>
                    <view class="more-list-title">图片</view>
                </view>
                <view class="more-list" @tap="sendImg('camera')">
                    <image src="/static/images/photograph.svg"></image>
                ...
                <view class="more-list">
                    <image src="/static/images/video.svg"></image>
                    <view class="more-list-title">视频</view>
                </view>
                <view class="more-list">
                    <image src="/static/images/file.svg"></image>
